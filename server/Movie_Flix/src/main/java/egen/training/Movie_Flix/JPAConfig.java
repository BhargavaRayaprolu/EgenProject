package egen.training.Movie_Flix;
...
public class JPAConfig {
	...
	public LocalContainerEntityManagerFactoryBean createEmf() {
		...
		emf.setPackagesToScan("egen.training.Movie_Flix.entity");
	...
	public DataSource dataSource() {
		...
		ds.setUrl("jdbc:mysql://localhost:3306/moviedb?useSSL=false");
		ds.setUsername("root");
		ds.setPassword("bhargh123");
		return ds;
	}
